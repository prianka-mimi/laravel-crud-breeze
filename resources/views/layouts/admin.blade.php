                ...
                <div class="col-md-3 top_right_menu text-end">
                    <div class="dropdown">
                      <button class="btn dropdown-toggle top_right_btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                          <img src="{{asset('contents_main/admin')}}/images/avatar.png" class="img-fluid">
                          {{Auth::User()->name}}
                      </button>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{url('profile')}}"><i class="fas fa-user-tie"></i> My Profile</a></li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-cog"></i> Manage Account</a></li>
                        <li><a class="dropdown-item" href="{{url('log-out')}}"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                      </ul>
                    </div>
                </div>
                <div class="clr"></div>
        ...
        <div class="container-fluid content_part">
            <div class="row">
                <div class="col-md-2 sidebar_part">
                    <div class="user_part">
                        <img class="" src="{{asset('contents_main/admin')}}/images/avatar.png" alt="avatar"/>
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{url('dashboard/recyclebin')}}"><i class="fas fa-trash"></i> RecycleBin</a></li>
                ...
                <div class="col-md-10 content">
                    <div class="row">
                        <div class="col-md-12 breadcumb_part mb-4">
                            {{-- <div class="bread">
                                <ul>
        ...
        <div class="container-fluid footer_part">
            <div class="row">
                ...
                <div class="col-md-10 copyright">
                    <p>Copyright &copy; 2024 | All rights reserved by Dashboard | Development By <a href="#">Fatema Akther Prianka</a></p>
                </div>
                <div class="clr"></div>
            </div>
        </div>
